...
```mermaid
flowchart LR
    A[1. Search<br/>ค้นหาเที่ยวบิน] --> B[2. Select Flight<br/>เลือกเที่ยวบิน]
    B --> C[3. Passenger<br/>ข้อมูลผู้โดยสาร]
    C --> D[4. Seat<br/>เลือกที่นั่งบนผัง]
    D --> E[5. Summary<br/>สรุปข้อมูลและราคา]
    E --> F[6. Payment<br/>ชำระเงิน]
    F --> G[7. Ticket<br/>รับ Boarding Pass]
```

* **Step 1: Search (ค้นหาเที่ยวบิน)** — ค้นหาตามสนามบินต้นทาง, ปลายทาง, วันเดินทาง, จำนวนผู้โดยสาร (ดึงรายชื่อสนามบินจากระบบ Storage)
* **Step 2: Select Flight (เลือกเที่ยวบิน)** — เปรียบเทียบเวลาบิน, ระยะเวลา, ราคาเริ่มต้น และกดเลือกเที่ยวบิน
* **Step 3: Passenger (ข้อมูลผู้โดยสาร)** — กรอกคำนำหน้า, ชื่อ-นามสกุล, เบอร์โทร, อีเมล, หมายเลขบัตรประชาชน/หนังสือเดินทาง, วันเกิด, และความต้องการพิเศษ
* **Step 4: Seat (เลือกที่นั่ง)** — เลือกที่นั่งผ่าน Interactive Aircraft Seat Map แบ่งชั้น Business Class (แถว 1-2) และ Economy Class (แถว 3-12) พร้อมระบบล็อกที่นั่ง 10 นาทีแบบ Real-time
* **Step 5: Summary (สรุปข้อมูลการจอง)** — ตรวจทานข้อมูลเที่ยวบิน, ข้อมูลผู้โดยสาร, เลขที่นั่ง และแจกแจงรายละเอียดค่าบริการ (ค่าตั๋ว, VAT 7%, ค่าธรรมเนียมสนามบิน) ก่อนชำระเงิน
* **Step 6: Payment (ชำระเงิน)** — รองรับ 3 ช่องทาง (บัตรเครดิต 3D Secure, PromptPay QR Code สแกนจ่ายพร้อมนับเวลาถอยหลัง 10 นาที, และ Mobile Banking)
* **Step 7: Ticket (บัตรโดยสาร)** — ออกบัตรขึ้นเครื่องอิเล็กทรอนิกส์ (Electronic Boarding Pass) พร้อม QR Code, รหัสการจอง PNR, รายละเอียดการเดินทาง และรองรับการสั่งพิมพ์ตั๋ว (`window.print()`)
